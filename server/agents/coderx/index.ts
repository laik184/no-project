...
export type { BuiltCodingPlan } from './planning/execution-plan-builder.ts';
...
export { buildDependencyGraph, getReadyTasks }   from './reasoning/dependency-analyzer.ts';
export type { DependencyGraph }                  from './reasoning/dependency-analyzer.ts';
...
export type { WorkingMemoryEntry }                from './memory/working-memory.ts';
export { executionHistory }                       from './memory/execution-history.ts';
export type { ExecutionSnapshot, RetryHistoryEntry } from './memory/execution-history.ts';

// ── Context ───────────────────────────────────────────────────────────────────
export { buildCoderXContext, toToolContext }       from './core/coderx-context.ts';
export type { CoderXContextInput }                from './core/coderx-context.ts';
