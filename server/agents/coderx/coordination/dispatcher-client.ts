/**
 * server/agents/coderx/coordination/dispatcher-client.ts
 *
 * THE single gateway from the CoderX agent to the central tool dispatcher.
...
import { dispatch, dispatchAll, dispatchSequential } from '../../executor/coordination/dispatcher-client.ts';
