/**
 * server/console/package/install-package-tool.ts
 *
 * Installs an npm package via PackageService + ProcessService.
...
export class InstallPackageTool implements ConsoleTool<InstallPackageInput, ConsoleToolResult<InstallPackageOutput>> {
  ...
  async execute(input: InstallPackageInput): Promise<ConsoleToolResult<InstallPackageOutput>> {
    try {
