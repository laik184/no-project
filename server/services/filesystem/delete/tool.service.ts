/**
 * server/services/filesystem/delete/tool.service.ts
 *
...
import {
  deleteFileFromSandbox, deleteMultipleFiles,
  type DeleteOptions, type DeleteResult,
} from '../../../tools/filesystem/lib/files/file-deleter.ts';

import {
  deleteFolder,
  type DeleteFolderOptions, type DeleteFolderResult,
